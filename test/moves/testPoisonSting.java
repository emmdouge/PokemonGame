...
/**
 * Tests the functionality of Poisonsting
 * @author Brandon Shawver
 */
public class testPoisonSting 
{
	/**
	...
	{
		Special PoisonSpecial = new Special();
		Move PS = new PoisonSting(PoisonSpecial);
		
		assertEquals("Poisonsting", PS.getName());
	}
	...
	public void testCheckStatusChange()
	{
		...
		assertTrue(PS.checkStatusChange(testDummy));
	}
}
